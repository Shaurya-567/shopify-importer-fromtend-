        ...
        return (
            ...
            <div className="container-fluid app-panel-container">
                ...
                {/*<div className="row">*/}
                    <div className="col-12">
                        <Switch>
                            ...
                            <Route  
                            exact
                            path="/panel/products/editsection/:id"
                ...
                {/* <Modal
                 ...
                 open={this.state.show_emaergency}
                 onClose={() => {
                 this.setState({show_emaergency: false});
                 }}
                 primaryAction={{
                 content: "OK",
                 onClick: () => {
                 ...
                 <p>
                 Server is under maintenance.We will be back online shortly
                 </p>
                 <br/>
