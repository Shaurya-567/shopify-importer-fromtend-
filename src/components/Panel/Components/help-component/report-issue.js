...
class ReportAnIssue extends Component {
    ...
    fbaSync() {
        console.log("Harshit FBA sync");
        requests
            .getRequest("fba/test/statusDetails",)
            .then(data1 => {
                if (data1['success']) {
                } else {
                }
                ...
                <div className="row">
                    ...
                    <div className="col-12 col-sm-4 order-1 order-sm-2 mb-3 mt-3">
                        ...
                        <div className="row p-5">
                            ...
                            <div className="row p-5-butoon ">
                            <div className="p-5-button col-4 shopify">
                                <Button
                                    onClick={() => {
                                        this.productSync();
                                    }}
                            ...
                            <div className="p-5-button col-4">
                                <Button
                                    onClick={() => {
