...
class Filter extends Component {
	...
	filterInt = [
		{ label: "equals", value: "1" },
		{ label: "not equals", value: "2" },
        {label: "greater than equal ", value: "8"},
        {label: "less than equal ", value: "9"},
	];
	...
	constructor(props) {
		...
		this.getAmazonAccountName();
	}

    getAmazonAccountName(){
        requests
            .getRequest("amazonimporter/request/getConnectedAccountName")
            .then(data => {
                if (data.success) {
                    // console.log(data.option.label.account_name)
                    this.setState({
                        amazonAccountName:data.option.label.account_name,
                        // amazon_list_type:data.option.label.account_name[0]
                    })
            ...
            case "account_name":
                return (
					<React.Fragment>
						<Select
							label={"Status"}
							options={this.state.amazonAccountName}
							placeholder={"Choose"}
							onChange={e => {
                                let columnFilterNameValue = this.state.columnFilterNameValue;
                                    columnFilterNameValue.condition = "account_name";
	...
	handleButtonFilterSubmit = () => {
        ...
        // console.log(columnFilterNameArray);
        // console.log(columnFilterNameValue);
		...
		this.setState({
            ...
            // console.log(this.state.columnFilterNameArray);
        });
